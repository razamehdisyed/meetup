      ...
      <div className='w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex bg-primary rounded-xl overflow-hidden shadow-xl'>
        ...
        <div className='hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue'>
          <div className='relative w-full flex items-center justify-center'>
            ...
            right-10 top-10 py-1 px-4 rounded-full'>
              <BsShare size={14} />
              <span className='text-xs font-medium'>Share</span>
            </div>
            <div className='absolute flex items-center gap-1 bg-white
            left-6 top-5 py-1 px-4 rounded-full'>
              <ImConnection />
              <span className='text-xs font-medium'>Connect</span>
            </div>
            <div className='absolute flex items-center gap-1 bg-white
            left-6 bottom-5 py-1 px-4 rounded-full'>
          ...
          <div className='mt-16 text-center'>
            <p className='text-white text-base'>
              Connect and share for fun
            </p>
            <span className='text-sm text-white/70'>
              Share your special memories with friends 
            </span>
          </div>
